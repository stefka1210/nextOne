...
})(["position:absolute;:first-child{left:0px;}:last-child{right:0px;}height:33%;transform:scale(1);transition:scale 800ms ease-in-out;z-index:11;svg{height:100%;}"]);
...
})(["background:#ccc;height:240px;display:flex;align-items:center;justify-content:center;cursor:pointer;&:hover{background:#9a9a9a;color:white;", "{transform:scale(1.8);transition:scale 800ms ease-in-out;}}"], FranLogo);
...
//# sourceMappingURL=schedules.js.8f01041f54923f43a5c4.hot-update.js.map