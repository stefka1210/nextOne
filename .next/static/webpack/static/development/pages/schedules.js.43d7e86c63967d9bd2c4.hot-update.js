...
Schedules.getInitialProps = function _callee() {
  var data, time, options, easternSearchdate, date, searchDate, matchesOnDate;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          easternSearchdate = new Intl.DateTimeFormat('de-DE', options).format(time);
          console.log('easternSearchdate:::', typeof easternSearchdate);
          console.log('time getDay:', time.getDay()); //ToDo: Eastern Standard Time
...
//# sourceMappingURL=schedules.js.43d7e86c63967d9bd2c4.hot-update.js.map