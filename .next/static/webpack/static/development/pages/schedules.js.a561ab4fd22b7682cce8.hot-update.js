...
})(["position:absolute;:first-child{left:0px;}:last-child{right:0px;}height:33%;transform:scale(1);transition:transform 2000ms ease-in-out;z-index:11;svg{height:100%;}"]);
...
})(["background:#ccc;height:240px;display:flex;align-items:center;justify-content:center;cursor:pointer;&:hover{background:#9a9a9a;color:white;", "{transform:scale(1.8);transition:transform 2000ms ease-in-out;}}"], FranLogo);
...
//# sourceMappingURL=schedules.js.a561ab4fd22b7682cce8.hot-update.js.map